...
def train_detector(model,
    ...
    if(cfg.get("backbone_init_weight_after_load", False) and isinstance(model.module.img_backbone, InternImage)):
        model.module.img_backbone.init_weights() # 这里会加载传入的pretrained
